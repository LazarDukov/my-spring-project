...
public class ProfileController {
    ...
    private String getMyProfile(Model model, Principal principal) {
        ...
        UserProfileView userProfileView = new UserProfileView(user.getUsername(), user.getFirstName(), user.getLastName(), user.getEmail(), user.getAge(), user.getRoles().stream().findFirst().map(UserRole::getRole).toString(), user.getCountry());
